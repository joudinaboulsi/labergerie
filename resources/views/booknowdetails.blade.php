...
@section('description', 'Book your dream getaway to Le Luberon with our exclusive package deals. Enjoy luxurious accommodations and stunning views.')
                        ...
                        <!--check in/out-->
                           <div class="">
                            <div id="nd_booking_open_calendar_from" class="">
                                ...
                                <div class="flex-box">
                                    <h2 id="nd_booking_date_number_from_front" class="nd_booking_date_number_from_front">{{$detail->from_day}}</h2>
                                    <h3 id="nd_booking_date_month_from_front" class="nd_booking_date_month_from_front">{{$detail->from_month}}</h3>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 booking-form-column">
                        <div class="">
                            <div id="nd_booking_open_calendar_to" class="">
                                ...
                                <div class="flex-box">
                                    <h2 id="nd_booking_date_number_to_front" class="nd_booking_date_number_from_front">{{$detail->to_day}}</h2>
                                    <h3 id="nd_booking_date_month_to_front" class="nd_booking_date_month_from_front">{{$detail->to_month}}</h3>
                                </div>
                            </div>
...
<div class="form-group col-md-6">
        ...
        <input type="date" class="form-control contact-form-one-input" name="end" value="" id="phone"
            placeholder="Phone Number" required>
                    ...
                    <div class="form-group col-md-12">
                        <button class="btn-one" type="submit" data-loading-text="Please wait..." style="float: left">Book
