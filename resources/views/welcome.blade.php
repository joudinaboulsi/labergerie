...
@section('description', 'La Bergerie du Luberon is an excellent choice for travelers, offering a family-friendly environment many helpful amenities designed to enhance your stay.')
                                        ...
                                        <div class="content-outer">
                                            <div class="content-box text-center justify-content-center">
                                                <div class="inner">
                                                    ...
                                                    <div class="link-box">
                                                        <a href="{{$slider->link_url}}" class="btn-one">{{$slider->link_text}} <span></span></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="auto-container">
                            <div class="row">
                                <div class="col-lg-5">
                                    ...
                                    <h2 class="about-one-title wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">{{$h->title_home}}</h2>
                                    <div class="about-one-text wow fadeInUp" data-wow-delay="500ms" data-wow-duration="1500ms">{!! $h->text_home !!}</div>
                               </div>
                               <div class="col-lg-7">
                                   <div class="about-one-image-box">
                                       <div class="about-one-image wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms"><div class="img_hover_1" style="box-shadow: 5px 10px 20px #888888;"><img src="/assets/home/{{$h->image_home}}" alt="la bergerie pool"></div></div>
                                       <div class="about-one-image-two"><div class="scroll-rotate"><img src="/assets/circle-shape.png" alt="la bergerie home"></div></div>
                                   </div>
                               </div>
                           </div>
                           <div class="bottom-text"><h4 class="about-one-text-two">{{$h->subtitle_home}}</h4></div>
                       </div>
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="info-slider wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                                        <div class="theme_carousel_wrapper">
                                            ...
                                            <div class="info-one-image wow fadeInRight" data-wow-delay="500ms" data-wow-duration="1500ms"><div class="img_hover_3"><img src="../assets/home/{{$h->imageone_info}}" alt="la bergerie garden"></div></div>

                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 offset-lg-1">
                                    <div class="info-one-text wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">{!!$h->contenetwo_info !!}</div>
                                    <div class="info-one-image wow fadeInRight" data-wow-delay="500ms" data-wow-duration="1500ms"><div class="img_hover_3"><img src="../assets/home/{{$h->imagetwo_info}}" alt="la bergerie view"></div></div>
                                </div>
                            </div>
                        </div>
                    </section>
